...
export function TransformationProgress({ currentPage, totalPages, onCancel }: TransformationProgressProps) {
      ...
      <CardContent className="p-6">
        ...
        <div className="space-y-4">
          ...
          <p className="text-sm text-gray-600 text-center">
            ...
            This process takes time to ensure the best quality results.
          </p>
        </div>
      </CardContent>
    </Card>
