...
export default function Auth() {
  ...
  const { signIn, signUp, signInWithGoogle, isGoogleAuthEnabled } = useAuth();
  ...
  const handleGoogleSignIn = async () => {
    ...
    // Don't set loading to false here as the OAuth flow will redirect
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-yellow-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-gray-500 mt-2">StoryMagic by My Little Illustrator</p>
        </div>
